...
def detect_accident(videopath):
    ...
    def parse_opt(videopath):
        parser = argparse.ArgumentParser()
        parser.add_argument('--weights', nargs='+', type=str, default='./training-results/weights/best.pt',
                            help='model path(s)')
        parser.add_argument('--source', type=str, default='./static/uploads/' + videopath,
